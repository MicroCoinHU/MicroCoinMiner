...
uses SysUtils,Classes, singleinstance {$ifndef fpc},Winapi.Windows{$endif};
...
Type
  ...
  Public
    ...
    // Extra methods.
    function FindOptionIndex(Const S : String; Var Longopt : Boolean; StartAt : Integer = -1) : Integer; overload;
